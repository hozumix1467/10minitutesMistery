...
import { ArrowLeft, FileText, AlertTriangle, Shield, Users, BookOpen } from 'lucide-react';
...
const TermsOfService: React.FC<TermsOfServiceProps> = ({ onBack, darkMode }) => {
  return (
          ...
          <div className={`prose max-w-none ${darkMode ? 'prose-invert' : ''}`}>
            <div className={`leading-relaxed text-base ${
              ...
              <div className="mb-8">
                ...
                <p>
                  この利用規約（以下「本規約」）は、10分事件簿（以下「当サイト」）の利用条件を定めるものです。
                  ユーザーの皆様（以下「ユーザー」）には、本規約に従って、当サイトをご利用いただきます。
                </p>
              </div>
              ...
              <section className="mb-8">
                ...
                <ol className="list-decimal list-inside space-y-2 ml-4">
                  ...
                  <li>当サイトは本サービスに関し、本規約のほか、ご利用にあたってのルール等、各種の定め（以下「個別規定」）をすることがあります。</li>
              ...
              <section className="mb-8">
                ...
                <ol className="list-decimal list-inside space-y-2 ml-4">
                  <li>当サイトは、ユーザーが以下のいずれかに該当する場合には、事前の通知なく、ユーザーに対して、本サービスの全部もしくは一部の利用を制限し、またはユーザーとしての登録を抹消することができるものとします。</li>
                </ol>
                <ul className="list-disc list-inside space-y-1 ml-8 mt-2">
